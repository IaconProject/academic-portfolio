  ...
  return (
    ...
    >
      <div className="relative mb-4 inline-block lg:hidden">
        <div
          className="relative mx-auto flex h-32 w-32 shrink-0 aspect-square items-center justify-center overflow-hidden rounded-full border-4 border-white bg-stone-100 shadow-xl ring-1 ring-stone-200 md:h-36 md:w-36"
