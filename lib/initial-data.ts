...
export const initialPortfolioData: PortfolioData = {
  ...
  seoSettings: {
    metaTitle: "Muhammed Akan Kimdir? | Akademik Biyografi",
    metaDescription: "Muhammed Akan kimdir? İlahiyat öğrencisi, araştırmacı ve yazılımcı Muhammed Akan'ın biyografisi; eğitimi, akademik çalışmaları, yayınları ve projeleri.",
    keywords: "İslam Hukuku, Yapay Zekâ Etiği, Blokzincir Teknolojisi, Yazılım, Siber Güvenlik, Dijital Dönüşüm",
    ogImageUrl: "https://www.muhammedakan.com/og.png",
    canonicalUrl: "https://www.muhammedakan.com",
    authorName: "Muhammed Akan",
    siteName: "Muhammed Akan | Akademik Biyografi",
    titleTemplate: "%s | Muhammed Akan",
    defaultLocale: "tr",
